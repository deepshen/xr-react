...
var _xrCosWeb = _interopRequireDefault(require("xr-cos-web"));
...
const Upload = props => {
  ...
  const upload = new _xrCosWeb.default({
    getAuth() {
  ...
  }, props.children ? props.children : /*#__PURE__*/_react.default.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
